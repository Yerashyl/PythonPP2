...
start_point_min = (int(minutes)/60)*360
start_point_sec = (int(seconds)/60)*360

mickey = pygame.image.load("week7/images/main-clock.png")
...
langle = -start_point_sec+90
rangle = -start_point_min+90
while True:
