...
eraser = pygame.transform.scale(pygame.image.load("week9/images/eraser.png"), (40, 40))
cleaner = pygame.transform.scale(pygame.image.load("week9/images/clean.jpg"), (40, 40))
pen = pygame.transform.scale(pygame.image.load("week9/images/pen.jpg"), (40, 40))
