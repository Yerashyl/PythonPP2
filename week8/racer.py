...
bg = pygame.image.load("week8/images/bg_racer.png")
DISPLAYSURF = pygame.display.set_mode((840,650))
DISPLAYSURF.fill(WHITE)
pygame.display.set_caption("Racer")
font = pygame.font.Font("week8/Fonts/Lato-Black.ttf", 60)
font_small = pygame.font.Font("week8/Fonts/Lato-Black.ttf", 40)
game_over = font.render("Game Over", True, BLUE)

#create class for coins, enemies and player car
